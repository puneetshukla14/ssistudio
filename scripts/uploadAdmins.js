...
function upload() {
    return __awaiter(this, void 0, void 0, function () {
        var workbook, sheet, data, _i, data_1, user, existing, hashedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connectDB()];
                case 1:
                    _a.sent();
                    workbook = XLSX.readFile('admins.xlsx');
                ...
                case 2:
                    ...
                    user = data_1[_i];
                    return [4 /*yield*/, Admin_1.Admin.findOne({ username: user.username })];
                case 3:
                    existing = _a.sent();
                    if (existing)
                        return [3 /*break*/, 6];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Admin_1.Admin.create({ username: user.username, password: hashedPassword })];
                case 5:
                    _a.sent();
                    _a.label = 6;
                case 6:
